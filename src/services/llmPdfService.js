...
const extractRulesWithLLM = async (policyText, policyId = null) => {
    ...
    try {
        ...
        const normalizedRules = extractedRules.map((r, idx) => ({
            ...
            threshold: r.threshold !== undefined ? parseFloat(r.threshold) || r.threshold : null,
            threshold_secondary: r.threshold_secondary !== undefined ? parseFloat(r.threshold_secondary) || null : null,
